...
<div id="eb-cart-registration-page" class="eb-container<?php echo $containerClass; ?>">
	...
	?>
	<form method="post" name="adminForm" id="adminForm" action="<?php echo $formUrl; ?>" autocomplete="off" class="<?php echo $formClass . $additionalFormClass; ?>" enctype="multipart/form-data">
	<?php
