...
try {
	...
	<div class="<?php echo implode(' ', $cssClasses); ?>">
		...
		{
		?>
			<div class="eb-event-price bg-primary text-white d-inline-block">
...
} catch (\Throwable $ex)
{
	try {
		...
		echo "<div class='alert alert-danger'>Erreur sur le site. Voir Themes de com_event_booking et remettre le default</div>";
