...
// Security
if (ModAnirataCalendlyHelper::isValidUUID($invitee_uuid) == false || ModAnirataCalendlyHelper::isValidUUID($event_type_uuid) == false) return;
